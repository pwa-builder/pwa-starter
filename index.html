...
<head>
  ...
  <meta name="description" content="This is a Cryptonit app" />
  ...
  <meta name="apple-mobile-web-app-title" content="Cryptonit" />
  <meta name="apple-mobile-web-app-status-bar-style" content="black" />
  
  <!-- This tag is used by the Cryptonit CLI to identify template projects. Don't remove if you are using the CLI. -->
  <meta name="cryptonit-template-identity" content="Cryptonit"/>
